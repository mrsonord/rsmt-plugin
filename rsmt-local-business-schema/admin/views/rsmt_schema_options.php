...
<tr>
   ...
   <td><select name="rsmt_type">
           <?php if (get_option("rsmt_type" ) !== '' ) { ?>
               <option value="<?php echo get_option( "rsmt_type" ); ?>"><?php echo get_option("rsmt_type"); ?></option>
           ...
           <option value="CafeOrCoffeeShop">Cafe Or CoffeeShop</option>
...
<tr style="background:#eeeeee;">
  <td></td>
   ...
   <!--<td><input type="text" placeholder="1" value="<?php echo get_option ( "rsmt_locations" ); ?>" name="rsmt_locations"></td>-->
</tr>
<tr>
...
<tr>
   <td>Google Places Url:</td>
   <td><input type="text" placeholder="https://plus.google.comu/0/b/116249051156178582482" value="<?php echo get_option("rmt_places_url"); ?>" name="rsmt_places_url_"></td>
   <td>Optional</td>
</tr>
<tr>
...
<tr>
   <td>Google Places Url:</td>
   <td><input type="text" placeholder="https://plus.google.comu/0/b/116249051156178582482" value="<?php echo get_option("smt_places_url"); ?>" name="rsmt_places_url_"></td>
   <td>Optional</td>
</tr>
<tr>
   <td>Use Geolocation</td>
   <td colspan="2"><input type="checkbox" name="rsmt_geo_location_two" <?php if ( get_option("rsmt_geo_location_two" ) == "on" ) {echo "checked";} ?> /> This will use Googles api to generate your geo location from the address entered above.</td>
</tr>
<tr>
  <td colspan="3"><hr></td>
</tr>
<tr style="background:#eeeeee;">
    <td></td>
    <td><h3>Contacts and Hours of operation</h3></td>
</tr>
<tr>
   <td>Email:</td>
...
<tr style="background:#eeeeee;">
  <td></td>
  <td><h3>Employees / Founders</h3></td>
</tr>
<tr>
...
<tr>
  ...
  <?php submit_button ('Save Changes', 'center button-primary', 'submit', false); ?>
</form>
<h3>
