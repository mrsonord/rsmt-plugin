...
define( 'RSMT_TOOLS_ID', 'rsmt-tools' );
...
if ( ! class_exists( 'RSMT_Tools' )  ) {
	class RSMT_Tools{
		...
		*/
		...
		/**
		 * function/activate
		 * Usage: create tables if not exist and activate the plugin
		 * Arg(0): null
		 * @return: void
		 */
		function rsmtActivate(){
			add_option( 'schema_status' );
			add_option( 'whitelabel_status' );
        ...
        /**
         * function/deactivate
         * Usage:Deactivates the plugin
         * Arg(0): null
         * @return: void
         */
        function rsmtDeactivate(){
            unregister_setting( 'RSMT_TOOLS_ID' . '_options', 'schema_status' );
            unregister_setting( 'RSMT_TOOLS_ID' . '_options', 'whitelabel_status' );
        ...
        function rsmtUninstall(){
            delete_option( 'schema_status' );
            delete_option( 'whitelabel_status' );
        ...
        function rsmtRegister(){
            register_setting( 'RSMT_TOOLS_ID' . '_options', 'schema_status' );
            register_setting( 'RSMT_TOOLS_ID' . '_options', 'whitelabel_status' );
...
require_once( 'admin/class.rsmt-admin.php' );
