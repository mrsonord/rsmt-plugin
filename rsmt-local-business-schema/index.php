...
if (!class_exists('RSMTSchema') ) {
    ...
    class RSMTSchema
        ...
        public function __construct(){
            ...
            //register_uninstall_hook ( __FILE__, array ( $this, 'rsmtUninstallrsmtUninstall'));
        }
         ...
         * @return: void
         */
        public static function rsmtActivate(){
         ...
         * @return: void
         */
        public static function rsmtDeactivate(){
         ...
         * @return: void
         */
        public static function rsmtUninstall(){
        ...
        public static function rsmtFilePath ($file) {
         ...
         * @return: void
         */
        public static function rsmtRegister(){
         ...
         * @return: void
         */
        public static function rsmtMenu()
        {
            add_options_page('RSMT Schema', 'RSMT Options', 'manage_options', 'rsmt_options', array('RSMTSchema', 'rsmtOptionsPage') );
        }
         ...
         * Return: void
         */
        public static function rsmtOptionsPage()
        {
            $plugin_id = 'RSMT_LOCAL_BUSINESS_SCHEMA_ID';
            // display options page
            include (self::rsmtFilePath('rsmt_options.php'));
        }
...
add_action('admin_init', array('RSMTSchema', 'rsmtRegister'));
add_action('admin_menu', array('RSMTSchema', 'rsmtMenu'));
//add_action('user_admin_menu', array('RSMTSchema', 'rsmtMenu'));
